		...
		<div class="page-content">
			<div class="panel panel-default">
				...
				<div class="panel-body">
					<form action="<%=path%>/test_update.action" method="post"
						id="addForm">
									...
									<div class="form-group">
										...
										<div class="col-sm-9 form-inline">
											<input id="content" name="content" size="35"
												class="form-control" type="text" value="${test.content}"
												tip="请输入问题" />
										</div>
									</div>
								</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-9 form-inline">
											<input id="option1" name="option1" size="35"
												class="form-control" type="text" value="${test.option1}"
												tip="请输入选项1" />
										</div>
									</div>
								</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-9 form-inline">
											<input id="option2" name="option2" size="35"
												class="form-control" type="text" value="${test.option2}"
												tip="请输入选项2" />
										</div>
									</div>
								</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-9 form-inline">
											<input id="option3" name="option3" size="35"
												class="form-control" type="text" value="${test.option3}"
												tip="请输入选项3" />
										</div>
									</div>
								</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-9 form-inline">
											<input id="option4" name="option4" size="35"
												class="form-control" type="text" value="${test.option4}"
												tip="请输入选项4" />
										</div>
									</div>
								</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-9 form-inline">
											<select id="okey" name="okey" class="form-control">
												<option <c:if test="${test.okey=='A'}">selected</c:if>
													value="A">
													A
												</option>
												<option <c:if test="${test.okey=='B'}">selected</c:if>
													value="B">
													B
												</option>
												<option <c:if test="${test.okey=='C'}">selected</c:if>
													value="C">
													C
												</option>
												<option <c:if test="${test.okey=='D'}">selected</c:if>
													value="D">
													D
												</option>
											</select>
									...
									<div class="form-group">
										...
										<div class="col-sm-9 form-inline">
											<input id="score" name="score" size="35" class="form-control"
												type="text" value="${test.score}" tip="请输入得分" />
										</div>
									</div>
								</div>
							</div>
