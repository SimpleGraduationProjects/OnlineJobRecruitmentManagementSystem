		...
		<div class="page-content">
			<div class="panel panel-default">
				...
				<div class="panel-body">
					<form action="<%=path%>/boss_upwd.action" method="post"
						id="addForm">
								...
								<div class="col-sm-8">
									<div class="form-group">
										...
										<div class="col-sm-9 form-inline">
											<input id="uname" name="uname" readonly="readonly" size="35"
												class="form-control" type="text"
												value="${sessionScope.boss.uname}" tip="请输入用户名" />
										</div>
									</div>
								</div>
							</div>
							<div class="row rowmargin">
								<div class="col-sm-8">
									<div class="form-group">
										...
										<div class="col-sm-9 form-inline">
											<input id="pwd" name="pwd" size="35" class="form-control"
												type="password" />
										</div>
									</div>
								</div>
							...
							<div class="row rowmargin">
								<div class="col-sm-8">
									<div class="form-group">
										...
										<div class="col-sm-9 form-inline">
											<input id="upwd1" name="upwd1" size="35" class="form-control"
												type="password" />
										</div>
									</div>
								</div>
	...
	$(document).ready(function() {
		...
		$("#addForm").validate({
			submitHandler : function(form) {//验证通过后的执行方法
				var opwd = '${sessionScope.boss.upwd}';
				var pwd = $('#pwd').val();
