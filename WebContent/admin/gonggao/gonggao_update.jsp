		...
		<div class="page-content">
			<div class="panel panel-default">
				...
				<div class="panel-body">
					<form action="<%=path%>/gonggao_update.action" method="post"
						id="addForm">
									...
									<div class="form-group">
										...
										<div class="col-sm-9 form-inline">
											<input id="name" name="name" size="35" class="form-control"
												type="text" value="${gonggao.name}" tip="请输入咨询标题" />
										</div>
									</div>
								</div>
							</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-9 form-inline">
											<select id="gtype" name="gtype" class="form-control">
												<option
													<c:if test="${gonggao.gtype=='面试技巧'}">selected</c:if>
													value="面试技巧">
													面试技巧
												</option>
												<option
													<c:if test="${gonggao.gtype=='应聘技巧'}">selected</c:if>
													value="应聘技巧">
													应聘技巧
												</option>
												<option
													<c:if test="${gonggao.gtype=='职场资讯'}">selected</c:if>
													value="职场资讯">
													职场资讯
												</option>
												<option
													<c:if test="${gonggao.gtype=='热点新闻'}">selected</c:if>
													value="热点新闻">
													热点新闻
												</option>
											</select>
							...
							<div class="row rowmargin">
								<div class="col-sm-7">
									<div class="form-group">
										...
										<div class="col-sm-9 form-inline">
											<input id="tupian" readonly="readonly" name="tupian" size="35"
												class="form-control" type="text" tip="请上传文件" value="${gonggao.tupian}"/>
									...
									<div class="form-group">
										...
										<div class="col-sm-9 form-inline">
											<textarea rows="5" cols="80" id="jianjie" name="jianjie"
												class="form-control" tip="请输入简介"  maxlength="200">${gonggao.jianjie}</textarea>
										</div>
									</div>
								</div>
							</div>
