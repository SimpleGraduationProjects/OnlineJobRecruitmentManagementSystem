		...
		<div class="page-content">
			<div class="panel panel-default">
				...
				<div class="panel-body">
					<form action="<%=path%>/catelog_update.action" method="post"
						id="addForm">
						<input name="id" type="hidden" value="${catelog.id}" />
									...
									<div class="form-group">
										...
										<div class="col-sm-9 form-inline">
											<input id="name" name="name" size="35" class="form-control"
												type="text" value="${catelog.name}" tip="请输入职位类别" />
										</div>
									</div>
								</div>
							</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-9 form-inline">
											<input id="miaoshu" name="miaoshu" size="35"
												class="form-control" type="text" value="${catelog.miaoshu}"
												tip="请输入描述" />
										</div>
									</div>
								</div>
