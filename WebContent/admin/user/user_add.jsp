									...
									<div class="form-group">
										...
										<div class="col-sm-9 form-inline">
											<input id="birthday" name="birthday" size="35"
												...
												onClick="WdatePicker()" type="text" value="" tip="请输入出生日期" />
										</div>
									</div>
								</div>
							</div>
							<div class="row rowmargin">
								<div class="col-sm-7">
									<div class="form-group">
										...
										<div class="col-sm-9 form-inline">
											<input id="photo" readonly="readonly" name="photo" size="35"
									...
									<div class="form-group">
										...
										<div class="col-sm-9 form-inline">
											<textarea rows="5" cols="80" id="gzjy" name="gzjy"
												class="form-control" tip="请输入工作经验"></textarea>
										</div>
									</div>
								</div>
							</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-9 form-inline">
											<input id="school" name="school" size="35"
												class="form-control" type="text" value="" tip="请输入毕业学校" />
										</div>
									</div>
								</div>
							</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-9 form-inline">
											<input id="zhuanye" name="zhuanye" size="35"
												class="form-control" type="text" value="" tip="请输入专业" />
										</div>
									</div>
								</div>
							</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-9 form-inline">
											<select id="zt" name="zt" class="form-control">
												<option value="离职-随时到岗">
													离职-随时到岗
												</option>
												<option value="在职-暂不考虑">
													在职-暂不考虑
												</option>
												<option value="在职-考虑机会">
													在职-考虑机会
												</option>
												<option value="在职-月内到岗">
													在职-月内到岗
												</option>
											</select>
										</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-9 form-inline">
											<textarea rows="5" cols="80" id="youdian" name="youdian"
												class="form-control" tip="请输入个人优势"></textarea>
										</div>
									</div>
								</div>
							</div>
